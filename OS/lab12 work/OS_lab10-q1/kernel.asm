...
80101ec8:	68 3e 79 10 80       	push   $0x8010793e
...
80102e62:	e8 09 2b 00 00       	call   80105970 <idtinit>
...
80102ee9:	e8 32 08 00 00       	call   80103720 <pinit>
  tvinit();        // trap vectors
80102eee:	e8 fd 29 00 00       	call   801058f0 <tvinit>
  binit();         // buffer cache
...
80103674:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103677:	c7 40 14 e2 58 10 80 	movl   $0x801058e2,0x14(%eax)
  p->context = (struct context*)sp;
...
80103726:	68 b5 76 10 80       	push   $0x801076b5
...
80103823:	e8 88 36 00 00       	call   80106eb0 <setupkvm>
...
80103841:	e8 4a 33 00 00       	call   80106b90 <inituvm>
...
801038af:	68 e5 76 10 80       	push   $0x801076e5
801038b4:	50                   	push   %eax
801038b5:	e8 76 0d 00 00       	call   80104630 <safestrcpy>
  p->cwd = namei("/");
801038ba:	c7 04 24 ee 76 10 80 	movl   $0x801076ee,(%esp)
...
801038f3:	68 cc 76 10 80       	push   $0x801076cc
...
8010392c:	e8 4f 31 00 00       	call   80106a80 <switchuvm>
  return 0;
...
8010394a:	e8 81 33 00 00       	call   80106cd0 <allocuvm>
...
8010396a:	e8 91 34 00 00       	call   80106e00 <deallocuvm>
...
801039b8:	e8 c3 35 00 00       	call   80106f80 <copyuvm>
...
80103af0:	e8 8b 2f 00 00       	call   80106a80 <switchuvm>
...
80103b02:	e8 84 0b 00 00       	call   8010468b <swtch>
      switchkvm();
80103b07:	e8 54 2f 00 00       	call   80106a60 <switchkvm>
      c->proc = 0;
...
80103d0d:	68 3d 77 10 80       	push   $0x8010773d
80103d12:	e8 79 c6 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103d17:	83 ec 0c             	sub    $0xc,%esp
80103d1a:	68 30 77 10 80       	push   $0x80107730
...
80103e29:	68 4f 77 10 80       	push   $0x8010774f
80103e2e:	e8 5d c5 ff ff       	call   80100390 <panic>
    panic("sleep");
80103e33:	83 ec 0c             	sub    $0xc,%esp
80103e36:	68 49 77 10 80       	push   $0x80107749
...
80103ed2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ed9:	e8 52 2f 00 00       	call   80106e30 <freevm>
        release(&ptable.lock);
...
8010404e:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104051:	ba 60 77 10 80       	mov    $0x80107760,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104056:	77 11                	ja     80104069 <procdump+0x59>
80104058:	8b 14 85 c0 77 10 80 	mov    -0x7fef8840(,%eax,4),%edx
      state = "???";
8010405f:	b8 60 77 10 80       	mov    $0x80107760,%eax
...
80104071:	68 64 77 10 80       	push   $0x80107764
...
801040ad:	68 a1 71 10 80       	push   $0x801071a1
...
801040da:	68 d8 77 10 80       	push   $0x801077d8
...
801042f5:	68 e3 77 10 80       	push   $0x801077e3
801042fa:	e8 91 c0 ff ff       	call   80100390 <panic>
    panic("popcli");
801042ff:	83 ec 0c             	sub    $0xc,%esp
80104302:	68 fa 77 10 80       	push   $0x801077fa
...
801043e7:	68 01 78 10 80       	push   $0x80107801
...
8010443c:	68 09 78 10 80       	push   $0x80107809
...
8010484a:	89 c6                	mov    %eax,%esi

  num = curproc->tf->eax;
8010484c:	8b 40 18             	mov    0x18(%eax),%eax
8010484f:	8b 58 1c             	mov    0x1c(%eax),%ebx
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104852:	8d 43 ff             	lea    -0x1(%ebx),%eax
80104855:	83 f8 14             	cmp    $0x14,%eax
80104858:	0f 87 e2 00 00 00    	ja     80104940 <syscall+0x100>
8010485e:	8b 04 9d c0 78 10 80 	mov    -0x7fef8740(,%ebx,4),%eax
80104865:	85 c0                	test   %eax,%eax
80104867:	0f 84 d3 00 00 00    	je     80104940 <syscall+0x100>
  	curproc->tf->eax = syscalls[num]();
8010486d:	ff d0                	call   *%eax
8010486f:	8b 56 18             	mov    0x18(%esi),%edx
  	if(num == SYS_fork)
80104872:	83 fb 01             	cmp    $0x1,%ebx
  	curproc->tf->eax = syscalls[num]();
80104875:	89 42 1c             	mov    %eax,0x1c(%edx)
  	if(num == SYS_fork)
80104878:	0f 84 0a 01 00 00    	je     80104988 <syscall+0x148>
  	{
  		cprintf("fork\n");
  	}
  	else if(num == SYS_exit)
8010487e:	83 fb 02             	cmp    $0x2,%ebx
80104881:	0f 84 e9 00 00 00    	je     80104970 <syscall+0x130>
  	{
  		cprintf("exit\n");
  	}
  	else if(num == SYS_wait)
80104887:	83 fb 03             	cmp    $0x3,%ebx
8010488a:	0f 84 10 01 00 00    	je     801049a0 <syscall+0x160>
  	{
  		cprintf("wait\n");
  	}
  	else if(num == SYS_pipe)
80104890:	83 fb 04             	cmp    $0x4,%ebx
80104893:	0f 84 1f 01 00 00    	je     801049b8 <syscall+0x178>
  	{
  		cprintf("pipe\n");
  	}
  	else if(num == SYS_read)
80104899:	83 fb 05             	cmp    $0x5,%ebx
8010489c:	0f 84 2e 01 00 00    	je     801049d0 <syscall+0x190>
  	{
  		cprintf("read\n");
  	}
  	else if(num == SYS_kill)
801048a2:	83 fb 06             	cmp    $0x6,%ebx
801048a5:	0f 84 3d 01 00 00    	je     801049e8 <syscall+0x1a8>
  	{
  		cprintf("kill\n");
  	}
  	else if(num == SYS_exec)
801048ab:	83 fb 07             	cmp    $0x7,%ebx
801048ae:	0f 84 64 01 00 00    	je     80104a18 <syscall+0x1d8>
  	{
  		cprintf("exec\n");
  	}
  	else if(num == SYS_fstat)
801048b4:	83 fb 08             	cmp    $0x8,%ebx
801048b7:	0f 84 73 01 00 00    	je     80104a30 <syscall+0x1f0>
  	{
  		cprintf("fstat\n");
  	}
  	else if(num == SYS_chdir)
801048bd:	83 fb 09             	cmp    $0x9,%ebx
801048c0:	0f 84 82 01 00 00    	je     80104a48 <syscall+0x208>
  	{
  		cprintf("chdir\n");
  	}
  	else if(num == SYS_dup)
801048c6:	83 fb 0a             	cmp    $0xa,%ebx
801048c9:	0f 84 91 01 00 00    	je     80104a60 <syscall+0x220>
  	{
  		cprintf("dup\n");
  	}
  	else if(num == SYS_getpid)
801048cf:	83 fb 0b             	cmp    $0xb,%ebx
801048d2:	0f 84 a0 01 00 00    	je     80104a78 <syscall+0x238>
  	{
  		cprintf("getpid\n");
  	}
  	else if(num == SYS_sbrk)
801048d8:	83 fb 0c             	cmp    $0xc,%ebx
801048db:	0f 84 af 01 00 00    	je     80104a90 <syscall+0x250>
  	{
  		cprintf("sbrk\n");
  	}
  	else if(num == SYS_sleep)
801048e1:	83 fb 0d             	cmp    $0xd,%ebx
801048e4:	0f 84 16 01 00 00    	je     80104a00 <syscall+0x1c0>
  	{
  		cprintf("sleep\n");
  	}
  	else if(num == SYS_uptime)
801048ea:	83 fb 0e             	cmp    $0xe,%ebx
801048ed:	0f 84 b2 01 00 00    	je     80104aa5 <syscall+0x265>
  	{
  		cprintf("uptime\n");
  	}
  	else if(num == SYS_open)
801048f3:	83 fb 0f             	cmp    $0xf,%ebx
801048f6:	0f 84 be 01 00 00    	je     80104aba <syscall+0x27a>
  	{
  		cprintf("open\n");
  	}
  	else if(num == SYS_write)
801048fc:	83 fb 10             	cmp    $0x10,%ebx
801048ff:	0f 84 ca 01 00 00    	je     80104acf <syscall+0x28f>
  	{
  		cprintf("write\n");
  	}
  	else if(num == SYS_mknod)
80104905:	83 fb 11             	cmp    $0x11,%ebx
80104908:	0f 84 eb 01 00 00    	je     80104af9 <syscall+0x2b9>
  	{
  		cprintf("mknode\n");
  	}
  	else if(num == SYS_unlink)
8010490e:	83 fb 12             	cmp    $0x12,%ebx
80104911:	0f 84 f7 01 00 00    	je     80104b0e <syscall+0x2ce>
  	{
  		cprintf("unlink\n");
  	}
  	else if(num == SYS_link)
80104917:	83 fb 13             	cmp    $0x13,%ebx
8010491a:	0f 84 03 02 00 00    	je     80104b23 <syscall+0x2e3>
  	{
  		cprintf("link\n");
  	}
  	else if(num == SYS_mkdir)
80104920:	83 fb 14             	cmp    $0x14,%ebx
80104923:	0f 84 bb 01 00 00    	je     80104ae4 <syscall+0x2a4>
  	{
  		cprintf("mkdir\n");
  	}
  	else
...
8010492c:	68 8f 78 10 80       	push   $0x8010788f
80104931:	e8 2a bd ff ff       	call   80100660 <cprintf>
80104936:	83 c4 10             	add    $0x10,%esp
80104939:	eb 24                	jmp    8010495f <syscall+0x11f>
8010493b:	90                   	nop
...
80104940:	8d 46 6c             	lea    0x6c(%esi),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104943:	53                   	push   %ebx
80104944:	50                   	push   %eax
80104945:	ff 76 10             	pushl  0x10(%esi)
80104948:	68 96 78 10 80       	push   $0x80107896
8010494d:	e8 0e bd ff ff       	call   80100660 <cprintf>
    curproc->tf->eax = -1;
80104952:	8b 46 18             	mov    0x18(%esi),%eax
80104955:	83 c4 10             	add    $0x10,%esp
80104958:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
...
80104973:	68 17 78 10 80       	push   $0x80107817
80104978:	e8 e3 bc ff ff       	call   80100660 <cprintf>
8010497d:	83 c4 10             	add    $0x10,%esp
80104980:	eb dd                	jmp    8010495f <syscall+0x11f>
80104982:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  		cprintf("fork\n");
80104988:	83 ec 0c             	sub    $0xc,%esp
8010498b:	68 11 78 10 80       	push   $0x80107811
80104990:	e8 cb bc ff ff       	call   80100660 <cprintf>
...
801049a3:	68 1d 78 10 80       	push   $0x8010781d
801049a8:	e8 b3 bc ff ff       	call   80100660 <cprintf>
801049ad:	83 c4 10             	add    $0x10,%esp
801049b0:	eb ad                	jmp    8010495f <syscall+0x11f>
801049b2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  		cprintf("pipe\n");
801049b8:	83 ec 0c             	sub    $0xc,%esp
801049bb:	68 23 78 10 80       	push   $0x80107823
801049c0:	e8 9b bc ff ff       	call   80100660 <cprintf>
801049c5:	83 c4 10             	add    $0x10,%esp
801049c8:	eb 95                	jmp    8010495f <syscall+0x11f>
801049ca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  		cprintf("read\n");
801049d0:	83 ec 0c             	sub    $0xc,%esp
801049d3:	68 29 78 10 80       	push   $0x80107829
801049d8:	e8 83 bc ff ff       	call   80100660 <cprintf>
801049dd:	83 c4 10             	add    $0x10,%esp
801049e0:	e9 7a ff ff ff       	jmp    8010495f <syscall+0x11f>
801049e5:	8d 76 00             	lea    0x0(%esi),%esi
  		cprintf("kill\n");
801049e8:	83 ec 0c             	sub    $0xc,%esp
801049eb:	68 2f 78 10 80       	push   $0x8010782f
801049f0:	e8 6b bc ff ff       	call   80100660 <cprintf>
801049f5:	83 c4 10             	add    $0x10,%esp
801049f8:	e9 62 ff ff ff       	jmp    8010495f <syscall+0x11f>
801049fd:	8d 76 00             	lea    0x0(%esi),%esi
  		cprintf("sleep\n");
80104a00:	83 ec 0c             	sub    $0xc,%esp
80104a03:	68 5c 78 10 80       	push   $0x8010785c
80104a08:	e8 53 bc ff ff       	call   80100660 <cprintf>
80104a0d:	83 c4 10             	add    $0x10,%esp
80104a10:	e9 4a ff ff ff       	jmp    8010495f <syscall+0x11f>
80104a15:	8d 76 00             	lea    0x0(%esi),%esi
  		cprintf("exec\n");
80104a18:	83 ec 0c             	sub    $0xc,%esp
80104a1b:	68 35 78 10 80       	push   $0x80107835
80104a20:	e8 3b bc ff ff       	call   80100660 <cprintf>
80104a25:	83 c4 10             	add    $0x10,%esp
80104a28:	e9 32 ff ff ff       	jmp    8010495f <syscall+0x11f>
80104a2d:	8d 76 00             	lea    0x0(%esi),%esi
  		cprintf("fstat\n");
80104a30:	83 ec 0c             	sub    $0xc,%esp
80104a33:	68 3b 78 10 80       	push   $0x8010783b
80104a38:	e8 23 bc ff ff       	call   80100660 <cprintf>
80104a3d:	83 c4 10             	add    $0x10,%esp
80104a40:	e9 1a ff ff ff       	jmp    8010495f <syscall+0x11f>
80104a45:	8d 76 00             	lea    0x0(%esi),%esi
  		cprintf("chdir\n");
80104a48:	83 ec 0c             	sub    $0xc,%esp
80104a4b:	68 42 78 10 80       	push   $0x80107842
80104a50:	e8 0b bc ff ff       	call   80100660 <cprintf>
80104a55:	83 c4 10             	add    $0x10,%esp
80104a58:	e9 02 ff ff ff       	jmp    8010495f <syscall+0x11f>
80104a5d:	8d 76 00             	lea    0x0(%esi),%esi
  		cprintf("dup\n");
80104a60:	83 ec 0c             	sub    $0xc,%esp
80104a63:	68 49 78 10 80       	push   $0x80107849
80104a68:	e8 f3 bb ff ff       	call   80100660 <cprintf>
80104a6d:	83 c4 10             	add    $0x10,%esp
80104a70:	e9 ea fe ff ff       	jmp    8010495f <syscall+0x11f>
80104a75:	8d 76 00             	lea    0x0(%esi),%esi
  		cprintf("getpid\n");
80104a78:	83 ec 0c             	sub    $0xc,%esp
80104a7b:	68 4e 78 10 80       	push   $0x8010784e
80104a80:	e8 db bb ff ff       	call   80100660 <cprintf>
80104a85:	83 c4 10             	add    $0x10,%esp
80104a88:	e9 d2 fe ff ff       	jmp    8010495f <syscall+0x11f>
80104a8d:	8d 76 00             	lea    0x0(%esi),%esi
  		cprintf("sbrk\n");
80104a90:	83 ec 0c             	sub    $0xc,%esp
80104a93:	68 56 78 10 80       	push   $0x80107856
80104a98:	e8 c3 bb ff ff       	call   80100660 <cprintf>
80104a9d:	83 c4 10             	add    $0x10,%esp
80104aa0:	e9 ba fe ff ff       	jmp    8010495f <syscall+0x11f>
  		cprintf("uptime\n");
80104aa5:	83 ec 0c             	sub    $0xc,%esp
80104aa8:	68 63 78 10 80       	push   $0x80107863
80104aad:	e8 ae bb ff ff       	call   80100660 <cprintf>
80104ab2:	83 c4 10             	add    $0x10,%esp
80104ab5:	e9 a5 fe ff ff       	jmp    8010495f <syscall+0x11f>
  		cprintf("open\n");
80104aba:	83 ec 0c             	sub    $0xc,%esp
80104abd:	68 6b 78 10 80       	push   $0x8010786b
80104ac2:	e8 99 bb ff ff       	call   80100660 <cprintf>
80104ac7:	83 c4 10             	add    $0x10,%esp
80104aca:	e9 90 fe ff ff       	jmp    8010495f <syscall+0x11f>
  		cprintf("write\n");
80104acf:	83 ec 0c             	sub    $0xc,%esp
80104ad2:	68 71 78 10 80       	push   $0x80107871
80104ad7:	e8 84 bb ff ff       	call   80100660 <cprintf>
80104adc:	83 c4 10             	add    $0x10,%esp
80104adf:	e9 7b fe ff ff       	jmp    8010495f <syscall+0x11f>
  		cprintf("mkdir\n");
80104ae4:	83 ec 0c             	sub    $0xc,%esp
80104ae7:	68 88 78 10 80       	push   $0x80107888
80104aec:	e8 6f bb ff ff       	call   80100660 <cprintf>
80104af1:	83 c4 10             	add    $0x10,%esp
80104af4:	e9 66 fe ff ff       	jmp    8010495f <syscall+0x11f>
  		cprintf("mknode\n");
80104af9:	83 ec 0c             	sub    $0xc,%esp
80104afc:	68 78 78 10 80       	push   $0x80107878
80104b01:	e8 5a bb ff ff       	call   80100660 <cprintf>
80104b06:	83 c4 10             	add    $0x10,%esp
80104b09:	e9 51 fe ff ff       	jmp    8010495f <syscall+0x11f>
  		cprintf("unlink\n");
80104b0e:	83 ec 0c             	sub    $0xc,%esp
80104b11:	68 80 78 10 80       	push   $0x80107880
80104b16:	e8 45 bb ff ff       	call   80100660 <cprintf>
80104b1b:	83 c4 10             	add    $0x10,%esp
80104b1e:	e9 3c fe ff ff       	jmp    8010495f <syscall+0x11f>
  		cprintf("link\n");
80104b23:	83 ec 0c             	sub    $0xc,%esp
80104b26:	68 82 78 10 80       	push   $0x80107882
80104b2b:	e8 30 bb ff ff       	call   80100660 <cprintf>
80104b30:	83 c4 10             	add    $0x10,%esp
80104b33:	e9 27 fe ff ff       	jmp    8010495f <syscall+0x11f>
...
80104c74:	68 34 79 10 80       	push   $0x80107934
...
80104c8c:	68 33 79 10 80       	push   $0x80107933
...
80104ca5:	68 27 79 10 80       	push   $0x80107927
...
80104cba:	68 36 79 10 80       	push   $0x80107936
80104cbf:	e8 cc b6 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104cc4:	83 ec 0c             	sub    $0xc,%esp
80104cc7:	68 18 79 10 80       	push   $0x80107918
...
80104cf2:	e8 59 fa ff ff       	call   80104750 <argint>
...
80104dbd:	e8 8e f9 ff ff       	call   80104750 <argint>
...
80104dd5:	e8 c6 f9 ff ff       	call   801047a0 <argptr>
...
80104e2d:	e8 1e f9 ff ff       	call   80104750 <argint>
...
80104e45:	e8 56 f9 ff ff       	call   801047a0 <argptr>
...
80104eef:	e8 ac f8 ff ff       	call   801047a0 <argptr>
...
80104f2f:	e8 cc f8 ff ff       	call   80104800 <argstr>
...
80104f48:	e8 b3 f8 ff ff       	call   80104800 <argstr>
...
8010507f:	e8 7c f7 ff ff       	call   80104800 <argstr>
...
801050b9:	58                   	pop    %eax
801050ba:	5a                   	pop    %edx
801050bb:	68 34 79 10 80       	push   $0x80107934
...
801050d4:	68 33 79 10 80       	push   $0x80107933
...
8010512e:	e8 1d f3 ff ff       	call   80104450 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
8010525f:	e8 9c f5 ff ff       	call   80104800 <argstr>
...
80105278:	e8 d3 f4 ff ff       	call   80104750 <argint>
...
801053c4:	e8 37 f4 ff ff       	call   80104800 <argstr>
...
80105424:	e8 d7 f3 ff ff       	call   80104800 <argstr>
...
80105439:	e8 12 f3 ff ff       	call   80104750 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010544e:	e8 fd f2 ff ff       	call   80104750 <argint>
     argint(1, &major) < 0 ||
...
801054bd:	e8 3e f3 ff ff       	call   80104800 <argstr>
...
80105565:	e8 96 f2 ff ff       	call   80104800 <argstr>
...
80105581:	e8 ca f1 ff ff       	call   80104750 <argint>
...
801055a6:	e8 a5 ee ff ff       	call   80104450 <memset>
...
801055c8:	e8 13 f1 ff ff       	call   801046e0 <fetchstr>
...
801055f0:	e8 ab f0 ff ff       	call   801046a0 <fetchint>
...
80105651:	e8 4a f1 ff ff       	call   801047a0 <argptr>
...
8010575c:	e8 ef ef ff ff       	call   80104750 <argint>
...
801057ad:	e8 9e ef ff ff       	call   80104750 <argint>
...
801057fd:	e8 4e ef ff ff       	call   80104750 <argint>
...
80105815:	e8 26 eb ff ff       	call   80104340 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010581a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010581d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105820:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  while(ticks - ticks0 < n){
...
80105865:	e8 96 eb ff ff       	call   80104400 <release>
      return -1;
...
80105888:	e8 73 eb ff ff       	call   80104400 <release>
  return 0;
...
801058a4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801058a7:	68 60 4c 11 80       	push   $0x80114c60
801058ac:	e8 8f ea ff ff       	call   80104340 <acquire>
  xticks = ticks;
801058b1:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  release(&tickslock);
801058b7:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
801058be:	e8 3d eb ff ff       	call   80104400 <release>
  return xticks;
}
...
80105907:	c7 04 c5 a2 4c 11 80 	movl   $0x8e000008,-0x7feeb35e(,%eax,8)
8010590e:	08 00 00 8e 
80105912:	66 89 14 c5 a0 4c 11 	mov    %dx,-0x7feeb360(,%eax,8)
80105919:	80 
8010591a:	c1 ea 10             	shr    $0x10,%edx
8010591d:	66 89 14 c5 a6 4c 11 	mov    %dx,-0x7feeb35a(,%eax,8)
80105924:	80 
  for(i = 0; i < 256; i++)
...
80105934:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105937:	c7 05 a2 4e 11 80 08 	movl   $0xef000008,0x80114ea2
8010593e:	00 00 ef 
  initlock(&tickslock, "time");
80105941:	68 79 79 10 80       	push   $0x80107979
80105946:	68 60 4c 11 80       	push   $0x80114c60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010594b:	66 a3 a0 4e 11 80    	mov    %ax,0x80114ea0
80105951:	c1 e8 10             	shr    $0x10,%eax
80105954:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6
  initlock(&tickslock, "time");
8010595a:	e8 a1 e8 ff ff       	call   80104200 <initlock>
}
...
8010597b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010597f:	b8 a0 4c 11 80       	mov    $0x80114ca0,%eax
...
801059c0:	ff 24 85 20 7a 10 80 	jmp    *-0x7fef85e0(,%eax,4)
...
801059d0:	e8 0b de ff ff       	call   801037e0 <myproc>
...
80105a01:	e8 da dd ff ff       	call   801037e0 <myproc>
...
80105a25:	68 dc 79 10 80       	push   $0x801079dc
...
80105a3e:	e8 9d dd ff ff       	call   801037e0 <myproc>
...
80105a64:	e8 77 dd ff ff       	call   801037e0 <myproc>
80105a69:	85 c0                	test   %eax,%eax
80105a6b:	74 0b                	je     80105a78 <trap+0xd8>
80105a6d:	e8 6e dd ff ff       	call   801037e0 <myproc>
...
80105ab2:	0f 85 e8 00 00 00    	jne    80105ba0 <trap+0x200>
    myproc()->tf = tf;
80105ab8:	e8 23 dd ff ff       	call   801037e0 <myproc>
80105abd:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105ac0:	e8 7b ed ff ff       	call   80104840 <syscall>
    if(myproc()->killed)
80105ac5:	e8 16 dd ff ff       	call   801037e0 <myproc>
...
80105b14:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105b18:	e8 f3 ca ff ff       	call   80102610 <kbdintr>
    lapiceoi();
...
80105b5f:	e8 5c dc ff ff       	call   801037c0 <cpuid>
80105b64:	56                   	push   %esi
80105b65:	53                   	push   %ebx
80105b66:	50                   	push   %eax
80105b67:	68 84 79 10 80       	push   $0x80107984
80105b6c:	e8 ef aa ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105b71:	e8 da cb ff ff       	call   80102750 <lapiceoi>
    break;
80105b76:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b79:	e8 62 dc ff ff       	call   801037e0 <myproc>
...
80105b8c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
80105b90:	e8 eb c4 ff ff       	call   80102080 <ideintr>
...
80105baa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105bb0:	e8 4b e0 ff ff       	call   80103c00 <exit>
80105bb5:	e9 aa fe ff ff       	jmp    80105a64 <trap+0xc4>
80105bba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105bc0:	83 ec 0c             	sub    $0xc,%esp
80105bc3:	68 60 4c 11 80       	push   $0x80114c60
80105bc8:	e8 73 e7 ff ff       	call   80104340 <acquire>
      wakeup(&ticks);
80105bcd:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
      ticks++;
80105bd4:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
80105bdb:	e8 50 e3 ff ff       	call   80103f30 <wakeup>
      release(&tickslock);
80105be0:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
80105be7:	e8 14 e8 ff ff       	call   80104400 <release>
80105bec:	83 c4 10             	add    $0x10,%esp
80105bef:	e9 09 ff ff ff       	jmp    80105afd <trap+0x15d>
80105bf4:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105bf7:	e8 c4 db ff ff       	call   801037c0 <cpuid>
...
80105c05:	68 a8 79 10 80       	push   $0x801079a8
80105c0a:	e8 51 aa ff ff       	call   80100660 <cprintf>
      panic("trap");
80105c0f:	83 c4 14             	add    $0x14,%esp
80105c12:	68 7e 79 10 80       	push   $0x8010797e
...
80105d0c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105d0f:	bb a0 7a 10 80       	mov    $0x80107aa0,%ebx
  ioapicenable(IRQ_COM1, 0);
...
8010687a:	e8 d1 db ff ff       	call   80104450 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801069d3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801069d6:	e8 e5 cd ff ff       	call   801037c0 <cpuid>
...
80106a60:	a1 a4 54 11 80       	mov    0x801154a4,%eax
{
...
80106aa4:	0f 84 c2 00 00 00    	je     80106b6c <switchuvm+0xec>
  pushcli();
80106aaa:	e8 c1 d7 ff ff       	call   80104270 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106aaf:	e8 8c cc ff ff       	call   80103740 <mycpu>
80106ab4:	89 c6                	mov    %eax,%esi
80106ab6:	e8 85 cc ff ff       	call   80103740 <mycpu>
...
80106ac8:	e8 73 cc ff ff       	call   80103740 <mycpu>
...
80106bbf:	e8 8c d8 ff ff       	call   80104450 <memset>
...
80106bf0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106bf1:	e9 0a d9 ff ff       	jmp    80104500 <memmove>
    panic("inituvm: more than a page");
80106bf6:	83 ec 0c             	sub    $0xc,%esp
80106bf9:	68 ed 7a 10 80       	push   $0x80107aed
...
80106d1b:	e8 30 d7 ff ff       	call   80104450 <memset>
...
80106d5d:	68 25 7b 10 80       	push   $0x80107b25
...
80106d93:	68 3d 7b 10 80       	push   $0x80107b3d
...
80106e9c:	68 59 7b 10 80       	push   $0x80107b59
...
80106ed0:	e8 7b d5 ff ff       	call   80104450 <memset>
...
80106f3b:	a3 a4 54 11 80       	mov    %eax,0x801154a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106f6f:	68 6a 7b 10 80       	push   $0x80107b6a
...
80106fc0:	e8 3b d5 ff ff       	call   80104500 <memmove>
...
80107059:	68 8e 7b 10 80       	push   $0x80107b8e
8010705e:	e8 2d 93 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107063:	83 ec 0c             	sub    $0xc,%esp
80107066:	68 74 7b 10 80       	push   $0x80107b74
...
801070ef:	e8 0c d4 ff ff       	call   80104500 <memmove>
    len -= n;
    buf += n;
