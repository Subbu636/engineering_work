...
80101ec8:	68 c2 77 10 80       	push   $0x801077c2
...
801037ad:	68 98 76 10 80       	push   $0x80107698
...
80103d0d:	68 3d 76 10 80       	push   $0x8010763d
80103d12:	e8 79 c6 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103d17:	83 ec 0c             	sub    $0xc,%esp
80103d1a:	68 30 76 10 80       	push   $0x80107630
...
80103e29:	68 4f 76 10 80       	push   $0x8010764f
80103e2e:	e8 5d c5 ff ff       	call   80100390 <panic>
    panic("sleep");
80103e33:	83 ec 0c             	sub    $0xc,%esp
80103e36:	68 49 76 10 80       	push   $0x80107649
...
8010402b:	68 db 79 10 80       	push   $0x801079db
...
8010404e:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104051:	ba 60 76 10 80       	mov    $0x80107660,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104056:	77 11                	ja     80104069 <procdump+0x59>
80104058:	8b 14 85 c0 76 10 80 	mov    -0x7fef8940(,%eax,4),%edx
      state = "???";
8010405f:	b8 60 76 10 80       	mov    $0x80107660,%eax
...
80104071:	68 64 76 10 80       	push   $0x80107664
...
801040ad:	68 a1 70 10 80       	push   $0x801070a1
...
801040da:	68 d8 76 10 80       	push   $0x801076d8
...
801042f5:	68 e3 76 10 80       	push   $0x801076e3
801042fa:	e8 91 c0 ff ff       	call   80100390 <panic>
    panic("popcli");
801042ff:	83 ec 0c             	sub    $0xc,%esp
80104302:	68 fa 76 10 80       	push   $0x801076fa
...
801043e7:	68 01 77 10 80       	push   $0x80107701
...
801049d4:	68 b8 77 10 80       	push   $0x801077b8
...
801049ec:	68 b7 77 10 80       	push   $0x801077b7
...
80104a05:	68 ab 77 10 80       	push   $0x801077ab
...
80104a1a:	68 ba 77 10 80       	push   $0x801077ba
80104a1f:	e8 6c b9 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104a24:	83 ec 0c             	sub    $0xc,%esp
80104a27:	68 9c 77 10 80       	push   $0x8010779c
...
80104e19:	58                   	pop    %eax
80104e1a:	5a                   	pop    %edx
80104e1b:	68 b8 77 10 80       	push   $0x801077b8
...
80104e34:	68 b7 77 10 80       	push   $0x801077b7
...
{
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105486:	bf 70 00 00 00       	mov    $0x70,%edi
8010548b:	89 c6                	mov    %eax,%esi
8010548d:	89 fa                	mov    %edi,%edx
8010548f:	31 c0                	xor    %eax,%eax
80105491:	83 ec 18             	sub    $0x18,%esp
80105494:	ee                   	out    %al,(%dx)
  microdelay(200);
80105495:	68 c8 00 00 00       	push   $0xc8
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010549a:	bb 71 00 00 00       	mov    $0x71,%ebx
8010549f:	e8 cc d2 ff ff       	call   80102770 <microdelay>
801054a4:	89 da                	mov    %ebx,%edx
801054a6:	ec                   	in     (%dx),%al
  return inb(CMOS_RETURN);
801054a7:	0f b6 c0             	movzbl %al,%eax
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801054aa:	89 fa                	mov    %edi,%edx
801054ac:	89 06                	mov    %eax,(%esi)
801054ae:	b8 02 00 00 00       	mov    $0x2,%eax
801054b3:	ee                   	out    %al,(%dx)
  microdelay(200);
801054b4:	c7 04 24 c8 00 00 00 	movl   $0xc8,(%esp)
801054bb:	e8 b0 d2 ff ff       	call   80102770 <microdelay>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801054c0:	89 da                	mov    %ebx,%edx
801054c2:	ec                   	in     (%dx),%al
  return inb(CMOS_RETURN);
801054c3:	0f b6 c0             	movzbl %al,%eax
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801054c6:	89 fa                	mov    %edi,%edx
801054c8:	89 46 04             	mov    %eax,0x4(%esi)
801054cb:	b8 04 00 00 00       	mov    $0x4,%eax
801054d0:	ee                   	out    %al,(%dx)
  microdelay(200);
801054d1:	c7 04 24 c8 00 00 00 	movl   $0xc8,(%esp)
801054d8:	e8 93 d2 ff ff       	call   80102770 <microdelay>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801054dd:	89 da                	mov    %ebx,%edx
801054df:	ec                   	in     (%dx),%al
  return inb(CMOS_RETURN);
801054e0:	0f b6 c0             	movzbl %al,%eax
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801054e3:	89 fa                	mov    %edi,%edx
801054e5:	89 46 08             	mov    %eax,0x8(%esi)
801054e8:	b8 07 00 00 00       	mov    $0x7,%eax
801054ed:	ee                   	out    %al,(%dx)
  microdelay(200);
801054ee:	c7 04 24 c8 00 00 00 	movl   $0xc8,(%esp)
801054f5:	e8 76 d2 ff ff       	call   80102770 <microdelay>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801054fa:	89 da                	mov    %ebx,%edx
801054fc:	ec                   	in     (%dx),%al
  return inb(CMOS_RETURN);
801054fd:	0f b6 c0             	movzbl %al,%eax
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105500:	89 fa                	mov    %edi,%edx
80105502:	89 46 0c             	mov    %eax,0xc(%esi)
80105505:	b8 08 00 00 00       	mov    $0x8,%eax
8010550a:	ee                   	out    %al,(%dx)
  microdelay(200);
8010550b:	c7 04 24 c8 00 00 00 	movl   $0xc8,(%esp)
80105512:	e8 59 d2 ff ff       	call   80102770 <microdelay>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105517:	89 da                	mov    %ebx,%edx
80105519:	ec                   	in     (%dx),%al
  return inb(CMOS_RETURN);
8010551a:	0f b6 c0             	movzbl %al,%eax
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
8010551d:	89 fa                	mov    %edi,%edx
8010551f:	89 46 10             	mov    %eax,0x10(%esi)
80105522:	b8 09 00 00 00       	mov    $0x9,%eax
80105527:	ee                   	out    %al,(%dx)
  microdelay(200);
80105528:	c7 04 24 c8 00 00 00 	movl   $0xc8,(%esp)
8010552f:	e8 3c d2 ff ff       	call   80102770 <microdelay>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105534:	89 da                	mov    %ebx,%edx
80105536:	ec                   	in     (%dx),%al
  return inb(CMOS_RETURN);
80105537:	0f b6 c0             	movzbl %al,%eax
...
8010553a:	83 c4 10             	add    $0x10,%esp
  return inb(CMOS_RETURN);
8010553d:	89 46 14             	mov    %eax,0x14(%esi)
}
...
8010558c:	e8 bf f1 ff ff       	call   80104750 <argint>
...
8010562d:	e8 1e f1 ff ff       	call   80104750 <argint>
...
80105645:	e8 f6 ec ff ff       	call   80104340 <acquire>
...
80105695:	e8 66 ed ff ff       	call   80104400 <release>
      return -1;
...
801056b8:	e8 43 ed ff ff       	call   80104400 <release>
  return 0;
...
80105700:	55                   	push   %ebp
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105701:	b8 0b 00 00 00       	mov    $0xb,%eax
80105706:	ba 70 00 00 00       	mov    $0x70,%edx
8010570b:	89 e5                	mov    %esp,%ebp
8010570d:	57                   	push   %edi
8010570e:	56                   	push   %esi
8010570f:	53                   	push   %ebx
80105710:	83 ec 58             	sub    $0x58,%esp
80105713:	ee                   	out    %al,(%dx)
  microdelay(200);
80105714:	68 c8 00 00 00       	push   $0xc8
80105719:	e8 52 d0 ff ff       	call   80102770 <microdelay>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010571e:	ba 71 00 00 00       	mov    $0x71,%edx
80105723:	ec                   	in     (%dx),%al
80105724:	83 e0 04             	and    $0x4,%eax
80105727:	8d 5d b8             	lea    -0x48(%ebp),%ebx
8010572a:	8d 75 d0             	lea    -0x30(%ebp),%esi
8010572d:	88 45 b7             	mov    %al,-0x49(%ebp)
80105730:	83 c4 10             	add    $0x10,%esp
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105733:	bf 0a 00 00 00       	mov    $0xa,%edi
80105738:	90                   	nop
...
80105742:	e8 39 fd ff ff       	call   80105480 <fill_rtcdate>
80105747:	89 f8                	mov    %edi,%eax
80105749:	ba 70 00 00 00       	mov    $0x70,%edx
8010574e:	ee                   	out    %al,(%dx)
  microdelay(200);
8010574f:	83 ec 0c             	sub    $0xc,%esp
80105752:	68 c8 00 00 00       	push   $0xc8
80105757:	e8 14 d0 ff ff       	call   80102770 <microdelay>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010575c:	ba 71 00 00 00       	mov    $0x71,%edx
80105761:	ec                   	in     (%dx),%al
    if(cmos_read(CMOS_STATA) & CMOS_UIP)
80105762:	83 c4 10             	add    $0x10,%esp
80105765:	84 c0                	test   %al,%al
80105767:	78 d7                	js     80105740 <sys_ssm+0x40>
        continue;
    fill_rtcdate(&t2);
80105769:	89 f0                	mov    %esi,%eax
8010576b:	e8 10 fd ff ff       	call   80105480 <fill_rtcdate>
    if(memcmp(&t1, &t2, sizeof(t1)) == 0)
80105770:	83 ec 04             	sub    $0x4,%esp
80105773:	6a 18                	push   $0x18
80105775:	56                   	push   %esi
80105776:	53                   	push   %ebx
80105777:	e8 24 ed ff ff       	call   801044a0 <memcmp>
8010577c:	83 c4 10             	add    $0x10,%esp
8010577f:	85 c0                	test   %eax,%eax
80105781:	75 bd                	jne    80105740 <sys_ssm+0x40>
      break;
  }

  // convert
  if(bcd) {
80105783:	80 7d b7 00          	cmpb   $0x0,-0x49(%ebp)
80105787:	8b 5d b8             	mov    -0x48(%ebp),%ebx
8010578a:	8b 55 bc             	mov    -0x44(%ebp),%edx
8010578d:	8b 4d c0             	mov    -0x40(%ebp),%ecx
80105790:	75 2a                	jne    801057bc <sys_ssm+0xbc>
#define    CONV(x)     (t1.x = ((t1.x >> 4) * 10) + (t1.x & 0xf))
    CONV(second);
80105792:	89 d8                	mov    %ebx,%eax
80105794:	83 e3 0f             	and    $0xf,%ebx
80105797:	c1 e8 04             	shr    $0x4,%eax
8010579a:	8d 04 80             	lea    (%eax,%eax,4),%eax
8010579d:	8d 1c 43             	lea    (%ebx,%eax,2),%ebx
    CONV(minute);
801057a0:	89 d0                	mov    %edx,%eax
801057a2:	83 e2 0f             	and    $0xf,%edx
801057a5:	c1 e8 04             	shr    $0x4,%eax
801057a8:	8d 04 80             	lea    (%eax,%eax,4),%eax
801057ab:	8d 14 42             	lea    (%edx,%eax,2),%edx
    CONV(hour  );
801057ae:	89 c8                	mov    %ecx,%eax
801057b0:	83 e1 0f             	and    $0xf,%ecx
801057b3:	c1 e8 04             	shr    $0x4,%eax
801057b6:	8d 04 80             	lea    (%eax,%eax,4),%eax
801057b9:	8d 0c 41             	lea    (%ecx,%eax,2),%ecx
    CONV(month );
    CONV(year  );
#undef     CONV
  }

  int ans = (t1.hour + 5)*3600 + (t1.minute + 30)*60 + (t1.second);
801057bc:	69 c9 10 0e 00 00    	imul   $0xe10,%ecx,%ecx
  return ans;
}
801057c2:	8d 65 f4             	lea    -0xc(%ebp),%esp
  int ans = (t1.hour + 5)*3600 + (t1.minute + 30)*60 + (t1.second);
801057c5:	6b d2 3c             	imul   $0x3c,%edx,%edx
801057c8:	8d 84 0b 58 4d 00 00 	lea    0x4d58(%ebx,%ecx,1),%eax
}
801057cf:	5b                   	pop    %ebx
  int ans = (t1.hour + 5)*3600 + (t1.minute + 30)*60 + (t1.second);
801057d0:	01 d0                	add    %edx,%eax
}
801057d2:	5e                   	pop    %esi
801057d3:	5f                   	pop    %edi
801057d4:	5d                   	pop    %ebp
...
8010584e:	00 00 ef 
  initlock(&tickslock, "time");
80105851:	68 fd 77 10 80       	push   $0x801077fd
...
80105864:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6
  initlock(&tickslock, "time");
8010586a:	e8 91 e9 ff ff       	call   80104200 <initlock>
}
...
801058d0:	ff 24 85 a4 78 10 80 	jmp    *-0x7fef875c(,%eax,4)
...
80105935:	68 60 78 10 80       	push   $0x80107860
...
801059cd:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
801059d0:	e8 6b ee ff ff       	call   80104840 <syscall>
    if(myproc()->killed)
...
80105ad8:	e8 63 e8 ff ff       	call   80104340 <acquire>
      wakeup(&ticks);
...
80105af7:	e8 04 e9 ff ff       	call   80104400 <release>
...
8010678a:	e8 c1 dc ff ff       	call   80104450 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106a69:	5d                   	pop    %ebp
  popcli();
80106a6a:	e9 41 d8 ff ff       	jmp    801042b0 <popcli>
...
80106c2b:	e8 20 d8 ff ff       	call   80104450 <memset>
...
80106de0:	e8 6b d6 ff ff       	call   80104450 <memset>
...
80106ed0:	e8 2b d6 ff ff       	call   80104500 <memmove>
...
80106f69:	68 12 7a 10 80       	push   $0x80107a12
80106f6e:	e8 1d 94 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106f73:	83 ec 0c             	sub    $0xc,%esp
80106f76:	68 f8 79 10 80       	push   $0x801079f8
