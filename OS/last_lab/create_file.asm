...
_create_file:     file format elf32-i386
  ...
  17:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  38:	e8 a3 02 00 00       	call   2e0 <atoi>
  3d:	89 85 e4 fd ff ff    	mov    %eax,-0x21c(%ebp)
  ...
  4c:	68 06 08 00 00       	push   $0x806
  51:	e8 3c 03 00 00       	call   392 <open>
  if(fd >= 0) 
  ...
  if(fd >= 0) 
  5d:	0f 88 80 00 00 00    	js     e3 <main+0xe3>
  {
      printf(1, "created\n");
  63:	50                   	push   %eax
  64:	50                   	push   %eax
  ...
  78:	7f 11                	jg     8b <main+0x8b>
  7a:	eb 4c                	jmp    c8 <main+0xc8>
  7c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    i++;
  80:	83 c6 01             	add    $0x1,%esi
  while(i < num_sectors)
  83:	39 b5 e4 fd ff ff    	cmp    %esi,-0x21c(%ebp)
  89:	74 3d                	je     c8 <main+0xc8>
    int var = write(fd, buf, 512);
  8b:	8d 85 e8 fd ff ff    	lea    -0x218(%ebp),%eax
  91:	83 ec 04             	sub    $0x4,%esp
  94:	68 00 02 00 00       	push   $0x200
  99:	50                   	push   %eax
  9a:	53                   	push   %ebx
  9b:	e8 d2 02 00 00       	call   372 <write>
    printf(1,"x");
  a0:	59                   	pop    %ecx
    int var = write(fd, buf, 512);
  a1:	89 c7                	mov    %eax,%edi
    printf(1,"x");
  a3:	58                   	pop    %eax
  a4:	68 1f 08 00 00       	push   $0x81f
  a9:	6a 01                	push   $0x1
  ab:	e8 f0 03 00 00       	call   4a0 <printf>
    if(var <= 0)
  b0:	83 c4 10             	add    $0x10,%esp
  b3:	85 ff                	test   %edi,%edi
  b5:	7f c9                	jg     80 <main+0x80>
      printf(1,"\nmemory limit exceeded\n");
  b7:	52                   	push   %edx
  b8:	52                   	push   %edx
  b9:	68 21 08 00 00       	push   $0x821
  be:	6a 01                	push   $0x1
  c0:	e8 db 03 00 00       	call   4a0 <printf>
      break;
  ...
  c8:	50                   	push   %eax
  c9:	56                   	push   %esi
  ca:	68 39 08 00 00       	push   $0x839
  cf:	6a 01                	push   $0x1
  d1:	e8 ca 03 00 00       	call   4a0 <printf>
  close(fd);
  d6:	89 1c 24             	mov    %ebx,(%esp)
  d9:	e8 9c 02 00 00       	call   37a <close>
  exit();
  de:	e8 6f 02 00 00       	call   352 <exit>
      printf(1, "error\n");
  e3:	50                   	push   %eax
  e4:	50                   	push   %eax
  e5:	68 18 08 00 00       	push   $0x818
  ea:	6a 01                	push   $0x1
  ec:	e8 af 03 00 00       	call   4a0 <printf>
      exit();
  f1:	e8 5c 02 00 00       	call   352 <exit>
  f6:	66 90                	xchg   %ax,%ax
  f8:	66 90                	xchg   %ax,%ax
  fa:	66 90                	xchg   %ax,%ax
  fc:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	e9 8f fe ff ff       	jmp    4e8 <printf+0x48>
          s = "(null)";
 659:	bb 4a 08 00 00       	mov    $0x84a,%ebx
        while(*s != 0){
