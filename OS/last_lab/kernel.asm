...
8010402b:	68 9b 79 10 80       	push   $0x8010799b
...
80104903:	74 1b                	je     80104920 <create+0x80>
      return ip;
    if(type ==  DUP_BLK_FILE && ip->type ==  DUP_BLK_FILE)
80104905:	66 83 7d d4 04       	cmpw   $0x4,-0x2c(%ebp)
8010490a:	75 1b                	jne    80104927 <create+0x87>
8010490c:	66 83 7f 50 04       	cmpw   $0x4,0x50(%edi)
80104911:	75 14                	jne    80104927 <create+0x87>
...
8010491d:	8d 76 00             	lea    0x0(%esi),%esi
    if(type == T_FILE && ip->type == T_FILE)
80104920:	66 83 7f 50 02       	cmpw   $0x2,0x50(%edi)
80104925:	74 ec                	je     80104913 <create+0x73>
    iunlockput(ip);
...
8010492b:	31 ff                	xor    %edi,%edi
    iunlockput(ip);
8010492d:	e8 de cf ff ff       	call   80101910 <iunlockput>
    return 0;
80104932:	83 c4 10             	add    $0x10,%esp
}
80104935:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
80104956:	0f 84 c8 00 00 00    	je     80104a24 <create+0x184>
  ilock(ip);
...
8010498e:	74 30                	je     801049c0 <create+0x120>
...
801049a2:	78 73                	js     80104a17 <create+0x177>
  iunlockput(dp);
801049a4:	83 ec 0c             	sub    $0xc,%esp
801049a7:	53                   	push   %ebx
801049a8:	e8 63 cf ff ff       	call   80101910 <iunlockput>
  return ip;
801049ad:	83 c4 10             	add    $0x10,%esp
}
801049b0:	8d 65 f4             	lea    -0xc(%ebp),%esp
801049b3:	89 f8                	mov    %edi,%eax
801049b5:	5b                   	pop    %ebx
801049b6:	5e                   	pop    %esi
801049b7:	5f                   	pop    %edi
801049b8:	5d                   	pop    %ebp
...
801049e4:	78 18                	js     801049fe <create+0x15e>
...
801049fc:	79 92                	jns    80104990 <create+0xf0>
      panic("create dots");
801049fe:	83 ec 0c             	sub    $0xc,%esp
80104a01:	68 6b 77 10 80       	push   $0x8010776b
80104a06:	e8 85 b9 ff ff       	call   80100390 <panic>
80104a0b:	90                   	nop
80104a0c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    return 0;
80104a10:	31 ff                	xor    %edi,%edi
80104a12:	e9 fc fe ff ff       	jmp    80104913 <create+0x73>
    panic("create: dirlink");
...
801054c1:	0f 85 a9 00 00 00    	jne    80105570 <sys_openmodf+0xf0>
    if(ip == 0){
      end_op();
      return -1;
    }
...
801054d9:	0f 84 b2 00 00 00    	je     80105591 <sys_openmodf+0x111>
      end_op();
      return -1;
    }
    ilock(ip);
...
801054f0:	0f 84 aa 00 00 00    	je     801055a0 <sys_openmodf+0x120>
      end_op();
      return -1;
    }
  }
...
801054ff:	0f 84 a6 00 00 00    	je     801055ab <sys_openmodf+0x12b>
  struct proc *curproc = myproc();
80105505:	e8 d6 e2 ff ff       	call   801037e0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010550a:	31 db                	xor    %ebx,%ebx
8010550c:	eb 0e                	jmp    8010551c <sys_openmodf+0x9c>
8010550e:	66 90                	xchg   %ax,%ax
80105510:	83 c3 01             	add    $0x1,%ebx
80105513:	83 fb 10             	cmp    $0x10,%ebx
80105516:	0f 84 ac 00 00 00    	je     801055c8 <sys_openmodf+0x148>
    if(curproc->ofile[fd] == 0){
8010551c:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
80105520:	85 d2                	test   %edx,%edx
80105522:	75 ec                	jne    80105510 <sys_openmodf+0x90>
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
...
801055c1:	eb 9a                	jmp    8010555d <sys_openmodf+0xdd>
801055c3:	90                   	nop
...
801055d4:	eb d5                	jmp    801055ab <sys_openmodf+0x12b>
...
801056dd:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
801056e0:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  while(ticks - ticks0 < n){
...
801057fe:	00 00 ef 
  initlock(&tickslock, "time");
80105801:	68 bd 77 10 80       	push   $0x801077bd
...
80105a27:	68 c8 77 10 80       	push   $0x801077c8
...
80105a83:	68 60 4c 11 80       	push   $0x80114c60
80105a88:	e8 b3 e8 ff ff       	call   80104340 <acquire>
      wakeup(&ticks);
80105a8d:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
      ticks++;
80105a94:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
80105a9b:	e8 90 e4 ff ff       	call   80103f30 <wakeup>
      release(&tickslock);
80105aa0:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
...
80105ac5:	68 ec 77 10 80       	push   $0x801077ec
80105aca:	e8 91 ab ff ff       	call   80100660 <cprintf>
      panic("trap");
80105acf:	83 c4 14             	add    $0x14,%esp
80105ad2:	68 c2 77 10 80       	push   $0x801077c2
...
80105bcc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105bcf:	bb e4 78 10 80       	mov    $0x801078e4,%ebx
  ioapicenable(IRQ_COM1, 0);
...
801067dd:	68 ec 78 10 80       	push   $0x801078ec
...
801068aa:	c7 80 f8 27 11 80 ff 	movl   $0xffff,-0x7feed808(%eax)
801068b1:	ff 00 00 
801068b4:	c7 80 fc 27 11 80 00 	movl   $0xcf9a00,-0x7feed804(%eax)
801068bb:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801068be:	c7 80 00 28 11 80 ff 	movl   $0xffff,-0x7feed800(%eax)
801068c5:	ff 00 00 
801068c8:	c7 80 04 28 11 80 00 	movl   $0xcf9200,-0x7feed7fc(%eax)
801068cf:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801068d2:	c7 80 08 28 11 80 ff 	movl   $0xffff,-0x7feed7f8(%eax)
801068d9:	ff 00 00 
801068dc:	c7 80 0c 28 11 80 00 	movl   $0xcffa00,-0x7feed7f4(%eax)
801068e3:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801068e6:	c7 80 10 28 11 80 ff 	movl   $0xffff,-0x7feed7f0(%eax)
801068ed:	ff 00 00 
801068f0:	c7 80 14 28 11 80 00 	movl   $0xcff200,-0x7feed7ec(%eax)
801068f7:	f2 cf 00 
...
80106ab9:	68 31 79 10 80       	push   $0x80107931
...
80106c1d:	68 69 79 10 80       	push   $0x80107969
...
80106c53:	68 81 79 10 80       	push   $0x80107981
...
80106f19:	68 d2 79 10 80       	push   $0x801079d2
80106f1e:	e8 6d 94 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106f23:	83 ec 0c             	sub    $0xc,%esp
80106f26:	68 b8 79 10 80       	push   $0x801079b8
